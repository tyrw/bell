...
exports.v1 = function (settings) {
    ...
    return async function (request, h) {
        ...
        if (!request.query.oauth_token) {
            ...
            console.log('oauth_callback', oauth_callback)
            try {
        ...
        try {
            console.log('settings v1 a', settings)
...
exports.v2 = function (settings) {
    ...
    console.log('settings v2', settings)
    return async function (request, h) {
...
internals.Client.prototype.temporary = function (oauth_callback) {
    ...
    console.log('temporary', this.settings.temporary)
